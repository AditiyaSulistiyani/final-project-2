...
public class FilterCatagoryBooks extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_filter_catagory_books);

        mdatabase = FirebaseDatabase.getInstance().getReference().child("barang").child("19");
        ndatabase = FirebaseDatabase.getInstance().getReference().child("barang").child("20");
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                product1.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        ...
                        Intent intent = new Intent (FilterCatagoryBooks.this, DetailActivity.class);
