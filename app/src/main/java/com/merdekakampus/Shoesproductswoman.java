...
public class Shoesproductswoman extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_shoesproductswoman);

        mdatabase = FirebaseDatabase.getInstance().getReference().child("barang").child("15");
        ndatabase = FirebaseDatabase.getInstance().getReference().child("barang").child("16");
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                product1.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        ...
                        Intent intent = new Intent (Shoesproductswoman.this, DetailActivity.class);
