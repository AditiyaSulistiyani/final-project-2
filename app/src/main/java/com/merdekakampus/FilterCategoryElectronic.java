...
public class FilterCategoryElectronic extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_filter_category_electronic);

        mdatabase = FirebaseDatabase.getInstance().getReference().child("barang").child("17");
        ndatabase = FirebaseDatabase.getInstance().getReference().child("barang").child("18");
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                product1.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        ...
                        Intent intent = new Intent (FilterCategoryElectronic.this, DetailActivity.class);
