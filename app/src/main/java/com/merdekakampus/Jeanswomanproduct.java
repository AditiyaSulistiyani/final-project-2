...
public class Jeanswomanproduct extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_jeanswomanproduct);


        mdatabase = FirebaseDatabase.getInstance().getReference().child("barang").child("13");
        ndatabase = FirebaseDatabase.getInstance().getReference().child("barang").child("14");
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                product1.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        ...
                        Intent intent = new Intent (Jeanswomanproduct.this, DetailActivity.class);
