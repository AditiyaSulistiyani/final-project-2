...
public class OtherCategoryFilter extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_other_category_filter);
        mdatabase = FirebaseDatabase.getInstance().getReference().child("barang").child("21");
        ndatabase = FirebaseDatabase.getInstance().getReference().child("barang").child("22");
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                product1.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        ...
                        Intent intent = new Intent (OtherCategoryFilter.this, DetailActivity.class);
